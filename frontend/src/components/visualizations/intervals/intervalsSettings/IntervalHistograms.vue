...
onUnmounted(() => {
    currentTrackList.selectTrack(props.id)[props.selectedIntervalVis][`${props.selectedIntervalVis}Height`] = currentTrackList.selectTrack(props.id)[props.selectedIntervalVis][`${props.selectedIntervalVis}Height`] -1
