...
import WaveformMarkersCreate from "./WaveformMarkersCreate.vue";
    ...
    <div class="flex flex-col boxTight rounded-md p-2 justify-center items-center">
      ...
      <Transition>
        <div
          ...
          class="absolute  z-1 rounded-md text-xs px-1 py-0.5 shadow-inner shadow-gray-500 top-9.5 overflow-x-hidden max-w-27"
          :class="backgroundColor ? backgroundColor : 'bg-white'"
        >
          {{ txtFileName }}
        </div>
      </Transition>
