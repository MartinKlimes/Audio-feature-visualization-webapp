...
<template>
  <form class="w-full bg-dark-500 bg-opacity-50 blur-sm pl-25 pr-25 pt-5 pb-5 text-white" id="register-form">
    ...
    <input
      ...
      :class="{ 'border-green-400 transition duration-500': !v$.email.$invalid, 'border-2 border-gray-300': v$.email.$invalid }"
      autocomplete="email"
    />
    ...
    <input
      ...
      :class="{ 'border-green-400 transition duration-500': !v$.username.$invalid, 'border-2 border-gray-300': v$.username.$invalid }"
    ...
    <input
      ...
      :class="{ 'border-green-400 transition duration-500': !v$.password.$invalid, 'border-2 border-gray-300': v$.password.$invalid }"
